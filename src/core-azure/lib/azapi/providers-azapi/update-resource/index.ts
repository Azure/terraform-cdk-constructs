...
export function updateResourceRetryToTerraform(
  struct?: UpdateResourceRetry | cdktf.IResolvable,
): any {
...
export class UpdateResourceRetryOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: UpdateResourceRetry | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export function updateResourceTimeoutsToTerraform(
  struct?: UpdateResourceTimeouts | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class UpdateResourceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: UpdateResourceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class UpdateResource extends cdktf.TerraformResource {
  ...
  private _timeouts = new UpdateResourceTimeoutsOutputReference(
    this,
    "timeouts",
  );
  public get timeouts() {

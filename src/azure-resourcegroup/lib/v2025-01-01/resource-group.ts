...
/**
 * Azure Resource Group using AZAPI provider with API version 2025-01-01
 *
...
export class Group extends AzapiResource {
  ...
  protected readonly apiVersion = "2025-01-01";
  ...
  /**
   * Creates an Azure Resource Group using AZAPI provider with API version 2025-01-01
   *
  ...
  constructor(scope: Construct, id: string, props: GroupProps) {
    ...
    // This must match the Azure API schema for Resource Groups API version 2025-01-01

...
import { LinuxFunctionApp, LinuxFunctionAppSiteConfig, LinuxFunctionAppSiteConfigApplicationStack,
  LinuxFunctionAppAuthSettings, LinuxFunctionAppAuthSettingsV2, LinuxFunctionAppIdentity,LinuxFunctionAppConnectionString
 ...
 */
export interface AzureLinuxFunctionAppProps {
  /**
...
export class AzureLinuxFunctionApp extends AzureResource {
   ...
   * ```
   */
  constructor(scope: Construct, id: string, props: AzureLinuxFunctionAppProps) {
    super(scope, id);
  ...
  private setupResourceGroup(props: AzureLinuxFunctionAppProps): ResourceGroup {
  ...
  private setupServicePlan(props: AzureLinuxFunctionAppProps): ServicePlan {

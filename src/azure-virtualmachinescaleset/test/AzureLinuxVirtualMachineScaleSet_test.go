...
func TestTerraformCDKAzureLinuxVirtualMachineScaleSetExample(t *testing.T) {
	t.Parallel()

	// Location of example file to test
	example_file := "./src/azure-virtualmachinescaleset/test/ExampleAzureLinuxVirtualMachineScaleSet.ts"

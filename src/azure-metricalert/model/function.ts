 ...
 */
export function monitorMetricAlertActionToTerraform(
  props?: MetricAlertActionProp,
): any {
 ...
 */
export function monitorMetricAlertCriteriaDimensionToTerraform(
  props?: MetricAlertCriteriaDimensionProp,
): any {
  if (!cdktf.canInspect(props)) {
    return props;
  }
 ...
 * @returns The dynamic criteria properties for a Metric Alert.
 */
export function monitorMetricAlertCriteriaToTerraform(
  props?: MetricAlertCriteriaProp,
): any {
  if (!cdktf.canInspect(props)) {
    return props;
  }
  return {
    ...
    dimension: cdktf.listMapper(
      monitorMetricAlertCriteriaDimensionToTerraform,
      true,
    )(props!.dimension),
  };
}
 ...
 * @returns The dynamic criteria properties for a Metric Alert.
 */
export function monitorMetricAlertDynamicCriteriaToTerraform(
  props?: MetricAlertDynamicCritiriaProps,
): any {
  if (!cdktf.canInspect(props)) {
    return props;
  }

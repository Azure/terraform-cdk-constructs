...
*/
export interface VirtualNetworkPeerProps {
  /**
   ...
   */
  remoteVirtualNetwork: AzureVirtualNetwork;
...
export class AzureVirtualNetworkPeer extends Construct {
  constructor(scope: Construct, name: string, props: VirtualNetworkPeerProps) {
    super(scope, name);

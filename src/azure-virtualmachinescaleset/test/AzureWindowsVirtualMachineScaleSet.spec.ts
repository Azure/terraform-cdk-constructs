...
describe('Azure Windows Virtual Machine  Scale Set Example', () => {
  ...
  it("renders the Azure Windows Virtual Machine Scale Set and checks snapshot", () => {
    ...
    expect(
      Testing.synth(new exampleAzureWindowsVirtualMachineScaleSet(Testing.app(), "testAzureWindowsVirtualMachineScaleSetExample"))
  ...
  it("check if the produced terraform configuration is valid", () => {
    ...
    expect(Testing.fullSynth(new exampleAzureWindowsVirtualMachineScaleSet(Testing.app(), "testAzureWindowsVirtualMachineScaleSetExample"))).toBeValidTerraform();
  });
  ...
  it("check if this can be planned", () => {
    ...
    // We need to do a full synth to plan the terraform configuration
    expect(Testing.fullSynth(new exampleAzureWindowsVirtualMachineScaleSet(Testing.app(), "testAzureWindowsVirtualMachineScaleSetExample"))).toPlanSuccessfully();
  });
});
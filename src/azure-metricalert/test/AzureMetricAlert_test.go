...
func TestTerraformCDKAzureMetricAlertExample(t *testing.T) {
	t.Parallel()

	// Location of example file to test
	example_file := "./src/azure-metricalert/test/ExampleAzureMetricAlert.ts"
	...
	// Determine whether the rg, log-analytics, alert exists
